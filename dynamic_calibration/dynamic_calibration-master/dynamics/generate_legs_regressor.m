function generate_legs_regressor(path_to_urdf)
% ---------------------------------------------------------------------
...
q_sym = sym('q%d',[4,1],'real');
qd_sym = sym('qd%d',[4,1],'real');
q2d_sym = sym('q2d%d',[4,1],'real');

% ------------------------------------------------------------------------
% Getting gradient of energy functions, to derive dynamics
% ------------------------------------------------------------------------
T_pk = sym(zeros(4,4,4)); % transformation between links
...
matlabFunction(Y_f,'File','autogen/standard_regressor_legs',...
